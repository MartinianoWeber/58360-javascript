...
const logoLenovo = document.querySelector(".image[alt='Logo de Lenovo']");
const logoSamsung = document.querySelector(".image[alt='Logo de Samsung']");
const logoSony = document.querySelector(".image[alt='Logo de Sony']");


btnVentas.addEventListener("click", function () {
    productosLenovo.style.display = "none";
    productosSamsung.style.display = "none";
    productosSony.style.display = "none";
...
logoLenovo.addEventListener("click", function () {
    marcas.style.display = "none";
    if (productosLenovo.style.display === "none") {
        productosLenovo.style.display = "block";
    } else {
        productosLenovo.style.display = "none";
    }
});

logoSamsung.addEventListener("click", function () {
    marcas.style.display = "none";
    if (productosSamsung.style.display === "none") {
        productosSamsung.style.display = "block";
    } else {
        productosSamsung.style.display = "none";
    }
});

logoSony.addEventListener("click", function () {
    marcas.style.display = "none";
    if (productosSony.style.display === "none") {
        productosSony.style.display = "block";
    } else {
        productosSony.style.display = "none";
    }
});
